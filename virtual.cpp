...
typedef struct superblock
{
 ...
 void man(char *name)
 {
   ...
   {
      printf("Description : Used to create new regula file\n");
    ...
    else if( strcmp(name,"read")==0)
    {
     ...
     printf("Usage : read File_name No_Bytes_to_read\n");
    ...
    {
      printf("Description : Used to close all opend file\n ");
        ...
        else if(strcmp(name,"lseek")==0)
    {
      ...
      printf("Usage :lseek file_name chnage in offset start point\n");
 ...
 while(i<50)
{
 ...
 void CreateDILB()
 {
    ...
    while(i <= MAXINODE)
    {
     ...
     printf("DILB crreate successfully\n");
...
int LseekFile(int fd,int size ,int from)
{
  ...
  printf("\nFile Name\tInode number \t size\t Link count\n");
  printf("-----------------------------------------------------\n");
  while(temp != NULL)
  {
    if(temp->FileType != 0)
  ...
  int main()
  {
    ...
    while(1)
    {
       ...
       if(strcmp(command[0],"lseek")==0)
       {
         ...
         if(fd == -1)
         {
            printf("ERROR : Incorerct parameter\n");
            continue;
